...
public class ToolTip : IDisposable
{
    ...
    internal static int SetTitle(IntPtr _wndTooltip, ToolTipIcon iconResult, string _title)
    {
        ...
        try
        {
            ...
            return SendMessage(_wndTooltip, TTM_SETTITLE, (int)iconResult, tempptr);
        }
        finally
        {
    ...
    public void Create()
    {
        ...
        if (!SetWindowPos(m_wndToolTip, WinApi.HWND_NOTOPMOST,
                    0, 0, 0, 0,
    ...
    public void Show(Point pt)
    {
        ...
        SetTitle(m_wndToolTip, iconResult, strTitle);

        //TrackPosition( m_wndToolTip, m_ownerForm.PointToScreen( pt ) );
